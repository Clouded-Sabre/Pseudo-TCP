...
func LoadConfig(filename string) (*lib.PcpCoreConfig, *lib.ConnectionConfig, error) {
	coreConfig := lib.DefaultPcpCoreConfig()        // default config
	pcpConfig := lib.DefaultPcpProtocolConnConfig() // default config
	connConfig := lib.DefaultConnectionConfig()     // default config
